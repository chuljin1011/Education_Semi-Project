...
이용자의 개인정보는 원칙적으로 개인정보의 수집 및 이용 목적 달성 시 지체없이 파기합니다. 다만 다른 법령에서 별도의 기간을 정하고 있는 경우나 이용자의 요청에 따라 기간을 달리 정한 경우에는 그 기간이 경과한 후 파기 등의 필요한 조치를 취합니다.</pre>
						...
						<br>
						<li><input type="checkbox" name="checkli_3" id="checkli_3">
							<label for="checkli_3">(선택) <span class="no_bold">개인정보 처리위탁</span>
						</label></li>
						<li>
							<table>
								<tr>
									<th>선택</th><th>고객 클레임 처리를 위한 CS 위탁</th>
								</tr>
								<tr>
									<td><input type="checkbox" name="checkli_4" id="checkli_4">
									<label for="checkli_4"><span class="no_bold">선택</span></label></td>
...
이용자의 개인정보는 원칙적으로 개인정보의 수집 및 이용 목적 달성 시 지체없이 파기합니다. 다만 다른 법령에서 별도의 기간을 정하고 있는 경우나 이용자의 요청에 따라 기간을 달리 정한 경우에는 그 기간이 경과한 후 파기 등의 필요한 조치를 취합니다.</pre>
						...
						<li><input type="checkbox" name="checkli_5" id="checkli_5">
							<label for="checkli_5">(선택) <span class="no_bold">개인정보 제 3자 제공</span>
						</label></li>
						<li>
							<table>
								<tr>
									<th>선택</th><th>마케팅 활용을 위한 개인정보 제3자 제공 동의</th>
								</tr>
								<tr>
...
이용자의 개인정보는 원칙적으로 개인정보의 수집 및 이용 목적 달성 시 지체없이 파기합니다. 다만 다른 법령에서 별도의 기간을 정하고 있는 경우나 이용자의 요청에 따라 기간을 달리 정한 경우에는 그 기간이 경과한 후 파기 등의 필요한 조치를 취합니다.</pre>
								...
								<tr>
									<th>선택</th><th>공급사 상품 판매 및 배송을 위한 개인정보 제3자 제공 동의</th>
								</tr>
								<tr>
...
- 보유/이용기간 : 배송완료 후 3개월</pre>
						...
						<li>
							<div id="btnDiv">
								<%--<button type="button" id="previousBtn">이전단계</button>--%>
